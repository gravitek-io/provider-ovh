...
PROJECT_REPO ?= github.com/gravitek-io/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-ovh_2.8.0
...
xpkg.build.provider-ovhcloud: do.build.images
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/ovhs/03-delete.yaml.tmpl.

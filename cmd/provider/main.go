...
import (
	...
	"github.com/gravitek-io/provider-ovh/apis"
	"github.com/gravitek-io/provider-ovh/apis/v1alpha1"
	"github.com/gravitek-io/provider-ovh/config"
	"github.com/gravitek-io/provider-ovh/internal/clients"
	"github.com/gravitek-io/provider-ovh/internal/controller"
	"github.com/gravitek-io/provider-ovh/internal/features"
)

func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for OVHcloud").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-ovhcloud"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-ovhcloud",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add OVHcloud APIs to scheme")
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup OVHcloud controllers")

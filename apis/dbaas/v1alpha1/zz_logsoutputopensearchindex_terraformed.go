...
func (mg *LogsOutputOpensearchIndex) GetTerraformResourceType() string {
	return "ovh_dbaas_logs_output_opensearch_index"
}
...
// LateInitialize this LogsOutputOpensearchIndex using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LogsOutputOpensearchIndex) LateInitialize(attrs []byte) (bool, error) {
	params := &LogsOutputOpensearchIndexParameters{}

...
func (mg *LogsOutputOpensearchAlias) GetTerraformResourceType() string {
	return "ovh_dbaas_logs_output_opensearch_alias"
}
...
// LateInitialize this LogsOutputOpensearchAlias using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LogsOutputOpensearchAlias) LateInitialize(attrs []byte) (bool, error) {
	params := &LogsOutputOpensearchAliasParameters{}

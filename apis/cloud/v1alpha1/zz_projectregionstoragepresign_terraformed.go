...
func (mg *ProjectRegionStoragePresign) GetTerraformResourceType() string {
	return "ovh_cloud_project_region_storage_presign"
}
...
// LateInitialize this ProjectRegionStoragePresign using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ProjectRegionStoragePresign) LateInitialize(attrs []byte) (bool, error) {
	params := &ProjectRegionStoragePresignParameters{}
